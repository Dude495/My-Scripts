...
(async function() {
    ...
    $('div#page-body p').eq(3).find('strong a').each( function(i){ arrBirthdayListDiscord[i] = $(this).text(); });
    ...
    function custMessage() {
        if (DBG == false) {
            ...
            const CUSTPMLink = URL + 'ucp.php?i=pm&mode=compose&subject=Happy Birthday ('+ today +')&message=' + CUSTMSG + optoutnotice + '&bcc_list=';
    ...
    function createMessage() {
        if (DBG == false) {
            ...
            const PMLink = URL + 'ucp.php?i=pm&mode=compose&subject=Happy Birthday ('+ today +')&message=' + PDMESSAGE + '&bcc_list=';
            let copyText = arrBirthdayList.join( '\n' );
            console.info('Birthdays for PM: \n\n'+copyText);
    ...
    function createBMessage() {
        if (DBG == false) {
            let today = localStorage.getItem('WMEBtoday');
            const BPMBlink = URL + 'ucp.php?i=pm&mode=compose&subject=Happy Birthday ('+ today +')&message=' + optoutnotice + '&bcc_list=';
            let copyText = arrBirthdayList.join( '\n' );
            console.info('Birthdays for PM: \n\n'+copyText);
    ...
    function BirthdayButton() {
        ...
        if (DBG == true) {
            ...
            cl.innerHTML = '  Use Pre-Defined PM Message (Beta)';
        }
        pdiv.after(box);
        box.after(cl);
        if (DBG == true) {
