...
(async function() {
    ...
    const MYNAME = document.querySelector("#control_bar_handler > div.header-waze-wrapper > wz-header > wz-header-user-panel > wz-user-box").shadowRoot.querySelector("div > wz-menu > div > div > span").textContent
    ...
    function init() {
        ...
        if (/forum/.test(location.href) && $("h3:contains(Birthdays)").length > 0) {
            ...
            var WMEBt = new Date().toISOString().slice(0, 10)
